...
<body>
  ...
  <div class="bg-white min-vh-100 px-5">
    <div class="container d-flex justify-content-between align-items-center mt-5 pt-5">
    ...
    <div class="container mt-5">
      <div class="pt-5">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addPassword">+ Add New Password</button>
      </div>
...
<!-- Include jQuery (make sure you have jQuery included in your project) -->
